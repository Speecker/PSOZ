...
// Midnight Ingot
val MidnightIngot = mods.modularmachinery.RecipeBuilder.newBuilder("midnight-ingot", "shadow_condenser", 2000, 0);
...
// Void Seed
val VoidSeed = mods.modularmachinery.RecipeBuilder.newBuilder("void-seed", "shadow_condenser", 2000, 0);
